...
object AppIcons {
    ...
    /** Yorug' mavzu — quyosh (kirish ekranidagi mavzu almashtirgich). */
    val Sun = strokeIcon(
        "Sun",
        "M 16 12 a 4 4 0 1 1 -8 0 a 4 4 0 1 1 8 0",
        "M 12 2 v 2",
        "M 12 20 v 2",
        "M 2 12 h 2",
        "M 20 12 h 2",
        "M 4.9 4.9 l 1.5 1.5",
        "M 17.6 17.6 l 1.5 1.5",
        "M 19.1 4.9 l -1.5 1.5",
        "M 6.4 17.6 l -1.5 1.5",
    )

    /** Tungi mavzu — oy (kirish ekranidagi mavzu almashtirgich). */
    val Moon = strokeIcon(
        "Moon",
        "M 21 12.8 A 9 9 0 1 1 11.2 3 a 7 7 0 0 0 9.8 9.8 z",
    )
